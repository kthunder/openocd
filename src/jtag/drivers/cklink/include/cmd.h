...
struct cli_command;
typedef int (*cli_callback_t)(struct cli_command *cmd, int argc, char **argv, void *priv);
...
struct cli_command *cli_command_register(char *name_of_parent, const char *short_name, const char *long_name,
                                         const char *help, cli_callback_t cb, void *priv, int hidden_in_cmdline,
                                         int hidden_in_gdb);
