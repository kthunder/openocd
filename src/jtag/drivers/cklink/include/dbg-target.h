/*
 * Copyright (C) 2024 Hangzhou C-SKY MicroSystems Co., Ltd. All rights reserved.
 *
...
extern "C"
{
    ...
    enum bkpt_type
    {
        ...
        BKPT_REPEATED, ///< GDB repeated bkpt in flash region
    };
    ...
    {
        TARGET_CONTINUOUS_M_PACKAGE,
        TARGET_CONTINUOUS_X_PACKAGE,
        TARGET_CONTINUOUS_m_PACKAGE,
    ...
    enum target_config_type
    {
        ...
        TARGET_CONFIG_CACHE_FLUSH,              ///< config to flush L1 or L2
        TARGET_CONFIG_SELECT_CPUN,              ///< config to select to CPUN with auto = 0
        TARGET_CONFIG_HALTAFTERRESET_FLAG,      ///< config if always set haltafterreset on
    };
    ...
    enum target_get_config_type
    {
        ...
        TARGET_GET_DCOMM_SUPPORT,           ///< get sampling supported
        TARGET_GET_CLUSTER_NUM,             ///< get cluster num
        TARGET_GET_CPUN_NORMAL_AT_CONNECT,  ///< get cpus[cpun].is_normal_at_connect
        TARGET_GET_HAS_DEBUGINFO2H,         ///< get if current target has debuginfo2h
    };
    ...
    */
    struct breakpoint
    {
        ...
        U64 sector_id_2;   ///< For FlashBp, the sector id for address crosses two sectors
    ...
    */
    ...
    struct check_cmderr_msg
    {
        enum target_continuous_mem_op_state state;
        int read;
        U64 start_addr;
        U64 end_addr;
    };
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int target_get_register_list(struct target *tgt, struct reg **reg_list, int *psize);
    /**
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int breakpoint_add(struct target *tgt, U64 address, unsigned int length, enum bkpt_type type);
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int watchpoint_add(struct target *tgt, U64 address, unsigned int length, int value,
    ...
    */
    TARGET_API struct watchpoint *watchpoint_find(struct target *tgt, U64 address, int st_ld_len, int is_st_ld);
    ...
    /**
      ...
      \return       None
    */
    TARGET_API void ck_check_mem_read(struct target *tgt, U64 address, unsigned char *data, unsigned int length);
    /**
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int target_execute_script(struct target *tgt, char *scrfilepath, int (*MsgOut)(const char *));
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int target_get_pc_sp_fp_regno(struct target *target, int *pc_regno, int *sp_regno, int *fp_regno);
    ...
    */
    ...
    /**
      ...
      \return       zero for success, negative for error
    */
    TARGET_API int target_get_message(struct target *tgt, enum target_message_type type, int arg, char *msg);
    ...
    */
    ...
    \return       zero for success, negative for error
    */
    TARGET_API int target_get_link_list(dbg_server_cfg_t *cfg, struct link_dev *dev, unsigned int *dev_count);
    /**
