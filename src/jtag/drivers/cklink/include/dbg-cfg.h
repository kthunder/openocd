...
#define IDLE_DELAY_0 0xf1f1f1f1
    ...
    struct arch_cfg
    {
        ...
        /* Haltafterreset always on. */
        unsigned int haltafterreset_always_on;
        /* Not Use Hardware Breakpoint Resources */
        int nouse_hbresouces;
    };

    struct smp_group_set
    {
        int set_cnt;
        U64 smp_elements[32];
    };
    ...
    struct socket_cfg
    {
        ...
        /* For parameter: -smp */
        struct smp_group_set smp_group;
    };
    ...
    struct flash_cfg
    {
        ...
        /* compat the old version of the algorithm file */
