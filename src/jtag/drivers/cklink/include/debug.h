...
extern "C"
{
    ...
    /* Init args */
    UTILS_API void dbg_debug_channel_init(int (*msgout)(const char *), int (*errout)(const char *), int verbose);
    ...
    UTILS_API int parse_options_handler(dbg_server_cfg_t *cfg, int argc, char *argv[], int *exit_skip_enter,
                                        int *check_target, char *msg, int from_ui);
