...
#define V1_IS_R1_ADJUSTER(x)                                                                                           \
    (V1_IS_ADDI1(x) || V1_IS_SUBI1(x) || V1_IS_ROTLI1(x) || V1_IS_BSETI1(x) || V1_IS_BCLRI1(x) || V1_IS_RSUBI1(x) ||   \
     V1_IS_NOT1(x) || V1_IS_MOVI1(x) || V1_IS_IXH1(x) || V1_IS_IXW1(x)) ||                                             \
...
#define V1_BR_OFFSET(insn)   ((insn & 0x400) ? (0 - (2 + ((0x3ff & insn) << 1))) : (2 + ((0x3ff & insn) << 1)))
...
#define V2_16_IS_ST(insn) (((insn & 0xe000) == 0xa000) && ((insn & 0x1800) != 0x1800))
/* size.  */
...
/* disp.  */
#define V2_16_STWx0_OFFSET(insn) ((((insn & 0x700) >> 3) + (insn & 0x1f)) << 2)
...
#define V2_16_IS_LD(insn) (((insn & 0xe000) == 0x8000) && (insn & 0x1800) != 0x1800)
/* size.  */
...
/* disp.  */
#define V2_16_SUBI_IMM(insn) ((((insn & 0x300) >> 3) + (insn & 0x1f)) << 2)
...
#define V2_16_IS_R4_ADJUSTER(x)                                                                                        \
    (V2_16_IS_ADDI4(x) || V2_16_IS_SUBI4(x) || V2_16_IS_BSETI4(x) || V2_16_IS_BCLRI4(x) || V2_16_IS_NOR4(x) ||         \
     V2_16_IS_LSLI4(x))
...
#define V2_32_IS_R4_ADJUSTER(x)                                                                                        \
    (V2_32_IS_ADDI4(x) || V2_32_IS_SUBI4(x) || V2_32_IS_ROTLI4(x) || V2_32_IS_IXH4(x) || V2_32_IS_IXW4(x) ||           \
