...
#define IS_SPECIAL_VALUE(cpid)                                                                                         \
    ((cpid == SPECIAL_VAL_0) || (cpid == SPECIAL_VAL_1) || (cpid == SPECIAL_VAL_2) || (cpid == SPECIAL_VAL_3))
...
#define CPID_SIGNOFF_Y_V3(cpid) (((((cpid)&0x000000f0) >> 4) * 100) + (((cpid)&0x0000000f)))
...
// index 2'
#define CPID_BTB_MCU_V6(cpid)          (((cpid)&0x00180000) >> 19) // bits 20:19
#define CPID_BHT_MCU_V6(cpid)          (((cpid)&0x00070000) >> 16) // bits 18:16
...
// Is CK807
#define CPID_V3_IS_CK807(cpid) (((cpid)&0xfffc000f) == 0x048c0003) // for CPID_v3 : CK807
#define CPID_V4_IS_X807(cpid)  (((cpid)&0xfffc0007) == 0x05000004) // for CPID_v4 : C/R807
...
#define CPID_V4_IS_X803(cpid)                                                                                          \
    ((((cpid)&0xfffc0007) == 0x04080004) || (((cpid)&0xfffc0007) == 0x04b40004)) // for CPID_v4 : E803, S803
...
#define CPID_V4_IS_X802(cpid)                                                                                          \
    ((((cpid)&0xfffc0007) == 0x04040004) || (((cpid)&0xfffc0007) == 0x04b00004)) // for CPID_v4 : E802, S802
...
#define HAD_V1           0 // 5xx/6xx
#define HAD_V2           1 // 810p
#define HAD_V3           2 // 810,860,804,801,802, 803
#define HAD_V4           3 // rv32+had
#define HAD_V5           4 // rv64+had
#define HAD_V6           5 // rvdm 0.11
#define HAD_V7           6 // rvdm 0.13
...
inline static int
HAD_ID_HACR_LENGTH(U32 hid)
{
    return (IS_16_HACR(hid) ? CK_HACR_16 : CK_HACR_8);
}

inline static int
HAD_ID_VERSION(U32 hid)
{
...
inline static int
ARCH_VERSION(U32 hid)
{
    return _ARCH_VERSION(hid);
}
inline static int
BKPT_NUM(U32 hid) // get target bkpt_num
{
...
#define CK_CPU_HAVE_VECTOR(cpid)                                                                                       \
    ((CPID_MODEL_V3(cpid) & 0x40) || ((CPID_VER_V4(cpid) == CPUIDVER_4) && (CPID_MODEL_V4(cpid) & 0x8)))
#define CK_CPU_HAVE_FLOAT(cpid)                                                                                        \
    ((CPID_MODEL_V3(cpid) & 0x4) || ((CPID_VER_V4(cpid) == CPUIDVER_4) && (CPID_MODEL_V4(cpid) & 0x1)))
