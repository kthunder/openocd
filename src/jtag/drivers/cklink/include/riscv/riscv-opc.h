...
DEFINE_CSR(senvcfg, CSR_SENVCFG)
...
DEFINE_CSR(stimecmp, CSR_STIMECMP)
DEFINE_CSR(stimecmph, CSR_STIMECMPH)
...
DEFINE_CSR(mconfigptr, CSR_MCONFIGPTR)
...
DEFINE_CSR(mtinst, CSR_MTINST)
DEFINE_CSR(mtval2, CSR_MTVAL2)
DEFINE_CSR(mclicbase, CSR_MCLICBASE)
DEFINE_CSR(mtvt, CSR_MTVT)
DEFINE_CSR(menvcfg, CSR_MENVCFG)
DEFINE_CSR(mstatush, CSR_MSTATUSH)
DEFINE_CSR(menvcfgh, CSR_MENVCFGH)
DEFINE_CSR(pmpcfg0, CSR_PMPCFG0)
DEFINE_CSR(pmpcfg1, CSR_PMPCFG1)
DEFINE_CSR(pmpcfg2, CSR_PMPCFG2)
DEFINE_CSR(pmpcfg3, CSR_PMPCFG3)
DEFINE_CSR(pmpcfg4, CSR_PMPCFG4)
DEFINE_CSR(pmpcfg5, CSR_PMPCFG5)
DEFINE_CSR(pmpcfg6, CSR_PMPCFG6)
DEFINE_CSR(pmpcfg7, CSR_PMPCFG7)
DEFINE_CSR(pmpcfg8, CSR_PMPCFG8)
DEFINE_CSR(pmpcfg9, CSR_PMPCFG9)
DEFINE_CSR(pmpcfg10, CSR_PMPCFG10)
DEFINE_CSR(pmpcfg11, CSR_PMPCFG11)
DEFINE_CSR(pmpcfg12, CSR_PMPCFG12)
DEFINE_CSR(pmpcfg13, CSR_PMPCFG13)
DEFINE_CSR(pmpcfg14, CSR_PMPCFG14)
DEFINE_CSR(pmpcfg15, CSR_PMPCFG15)
...
DEFINE_CSR(pmpaddr16, CSR_PMPADDR16)
DEFINE_CSR(pmpaddr17, CSR_PMPADDR17)
DEFINE_CSR(pmpaddr18, CSR_PMPADDR18)
DEFINE_CSR(pmpaddr19, CSR_PMPADDR19)
DEFINE_CSR(pmpaddr20, CSR_PMPADDR20)
DEFINE_CSR(pmpaddr21, CSR_PMPADDR21)
DEFINE_CSR(pmpaddr22, CSR_PMPADDR22)
DEFINE_CSR(pmpaddr23, CSR_PMPADDR23)
DEFINE_CSR(pmpaddr24, CSR_PMPADDR24)
DEFINE_CSR(pmpaddr25, CSR_PMPADDR25)
DEFINE_CSR(pmpaddr26, CSR_PMPADDR26)
DEFINE_CSR(pmpaddr27, CSR_PMPADDR27)
DEFINE_CSR(pmpaddr28, CSR_PMPADDR28)
DEFINE_CSR(pmpaddr29, CSR_PMPADDR29)
DEFINE_CSR(pmpaddr30, CSR_PMPADDR30)
DEFINE_CSR(pmpaddr31, CSR_PMPADDR31)
DEFINE_CSR(pmpaddr32, CSR_PMPADDR32)
DEFINE_CSR(pmpaddr33, CSR_PMPADDR33)
DEFINE_CSR(pmpaddr34, CSR_PMPADDR34)
DEFINE_CSR(pmpaddr35, CSR_PMPADDR35)
DEFINE_CSR(pmpaddr36, CSR_PMPADDR36)
DEFINE_CSR(pmpaddr37, CSR_PMPADDR37)
DEFINE_CSR(pmpaddr38, CSR_PMPADDR38)
DEFINE_CSR(pmpaddr39, CSR_PMPADDR39)
DEFINE_CSR(pmpaddr40, CSR_PMPADDR40)
DEFINE_CSR(pmpaddr41, CSR_PMPADDR41)
DEFINE_CSR(pmpaddr42, CSR_PMPADDR42)
DEFINE_CSR(pmpaddr43, CSR_PMPADDR43)
DEFINE_CSR(pmpaddr44, CSR_PMPADDR44)
DEFINE_CSR(pmpaddr45, CSR_PMPADDR45)
DEFINE_CSR(pmpaddr46, CSR_PMPADDR46)
DEFINE_CSR(pmpaddr47, CSR_PMPADDR47)
DEFINE_CSR(pmpaddr48, CSR_PMPADDR48)
DEFINE_CSR(pmpaddr49, CSR_PMPADDR49)
DEFINE_CSR(pmpaddr50, CSR_PMPADDR50)
DEFINE_CSR(pmpaddr51, CSR_PMPADDR51)
DEFINE_CSR(pmpaddr52, CSR_PMPADDR52)
DEFINE_CSR(pmpaddr53, CSR_PMPADDR53)
DEFINE_CSR(pmpaddr54, CSR_PMPADDR54)
DEFINE_CSR(pmpaddr55, CSR_PMPADDR55)
DEFINE_CSR(pmpaddr56, CSR_PMPADDR56)
DEFINE_CSR(pmpaddr57, CSR_PMPADDR57)
DEFINE_CSR(pmpaddr58, CSR_PMPADDR58)
DEFINE_CSR(pmpaddr59, CSR_PMPADDR59)
DEFINE_CSR(pmpaddr60, CSR_PMPADDR60)
DEFINE_CSR(pmpaddr61, CSR_PMPADDR61)
DEFINE_CSR(pmpaddr62, CSR_PMPADDR62)
DEFINE_CSR(pmpaddr63, CSR_PMPADDR63)
...
DEFINE_CSR(mhpmevent3h, CSR_MHPMEVENT3H)
DEFINE_CSR(mhpmevent4h, CSR_MHPMEVENT4H)
DEFINE_CSR(mhpmevent5h, CSR_MHPMEVENT5H)
DEFINE_CSR(mhpmevent6h, CSR_MHPMEVENT6H)
DEFINE_CSR(mhpmevent7h, CSR_MHPMEVENT7H)
DEFINE_CSR(mhpmevent8h, CSR_MHPMEVENT8H)
DEFINE_CSR(mhpmevent9h, CSR_MHPMEVENT9H)
DEFINE_CSR(mhpmevent10h, CSR_MHPMEVENT10H)
DEFINE_CSR(mhpmevent11h, CSR_MHPMEVENT11H)
DEFINE_CSR(mhpmevent12h, CSR_MHPMEVENT12H)
DEFINE_CSR(mhpmevent13h, CSR_MHPMEVENT13H)
DEFINE_CSR(mhpmevent14h, CSR_MHPMEVENT14H)
DEFINE_CSR(mhpmevent15h, CSR_MHPMEVENT15H)
DEFINE_CSR(mhpmevent16h, CSR_MHPMEVENT16H)
DEFINE_CSR(mhpmevent17h, CSR_MHPMEVENT17H)
DEFINE_CSR(mhpmevent18h, CSR_MHPMEVENT18H)
DEFINE_CSR(mhpmevent19h, CSR_MHPMEVENT19H)
DEFINE_CSR(mhpmevent20h, CSR_MHPMEVENT20H)
DEFINE_CSR(mhpmevent21h, CSR_MHPMEVENT21H)
DEFINE_CSR(mhpmevent22h, CSR_MHPMEVENT22H)
DEFINE_CSR(mhpmevent23h, CSR_MHPMEVENT23H)
DEFINE_CSR(mhpmevent24h, CSR_MHPMEVENT24H)
DEFINE_CSR(mhpmevent25h, CSR_MHPMEVENT25H)
DEFINE_CSR(mhpmevent26h, CSR_MHPMEVENT26H)
DEFINE_CSR(mhpmevent27h, CSR_MHPMEVENT27H)
DEFINE_CSR(mhpmevent28h, CSR_MHPMEVENT28H)
DEFINE_CSR(mhpmevent29h, CSR_MHPMEVENT29H)
DEFINE_CSR(mhpmevent30h, CSR_MHPMEVENT30H)
DEFINE_CSR(mhpmevent31h, CSR_MHPMEVENT31H)
DEFINE_CSR(mseccfg, CSR_MSECCFG)
DEFINE_CSR(mseccfgh, CSR_MSECCFGH)
...
DEFINE_CSR(mscontext, CSR_MSCONTEXT)
...
DEFINE_CSR(mcindexh, CSR_MCINDEXH)
DEFINE_CSR(mcdata0h, CSR_MCDATA0H)
DEFINE_CSR(mcdata1h, CSR_MCDATA1H)
DEFINE_CSR(mhpmcr, CSR_MHPMCR)
DEFINE_CSR(mhpmsr, CSR_MHPMSR)
DEFINE_CSR(mhpmer, CSR_MHPMER)
DEFINE_CSR(msmpr, CSR_MSMPR)
DEFINE_CSR(mzoneid, CSR_MZONEID)
DEFINE_CSR(ml2pid, CSR_ML2PID)
DEFINE_CSR(ml2wp, CSR_ML2WP)
/* TCM */
DEFINE_CSR(mdtcmcr, CSR_MDTCMCR)
DEFINE_CSR(mitcmcr, CSR_MITCMCR)
DEFINE_CSR(miesr, CSR_MIESR)
DEFINE_CSR(msbepa, CSR_MSBEPA)
DEFINE_CSR(msbepa2, CSR_MSBEPA2)
DEFINE_CSR(ml2wph, CSR_ML2WPH)
DEFINE_CSR(mcerh, CSR_MCERH)
DEFINE_CSR(mcer2h, CSR_MCER2H)
DEFINE_CSR(fxcr, CSR_FXCR)
DEFINE_CSR(twcounter, CSR_TWCOUNTER)
DEFINE_CSR(smir, CSR_SMIR)
DEFINE_CSR(smel, CSR_SMEL)
DEFINE_CSR(smeh, CSR_SMEH)
DEFINE_CSR(smcir, CSR_SMCIR)
DEFINE_CSR(scycleh, CSR_SCYCLEH)
DEFINE_CSR(sinstreth, CSR_SINSTRETH)
DEFINE_CSR(shpmcounter3h, CSR_SHPMCOUNTER3H)
DEFINE_CSR(shpmcounter4h, CSR_SHPMCOUNTER4H)
DEFINE_CSR(shpmcounter5h, CSR_SHPMCOUNTER5H)
DEFINE_CSR(shpmcounter6h, CSR_SHPMCOUNTER6H)
DEFINE_CSR(shpmcounter7h, CSR_SHPMCOUNTER7H)
DEFINE_CSR(shpmcounter8h, CSR_SHPMCOUNTER8H)
DEFINE_CSR(shpmcounter9h, CSR_SHPMCOUNTER9H)
DEFINE_CSR(shpmcounter10h, CSR_SHPMCOUNTER10H)
DEFINE_CSR(shpmcounter11h, CSR_SHPMCOUNTER11H)
DEFINE_CSR(shpmcounter12h, CSR_SHPMCOUNTER12H)
DEFINE_CSR(shpmcounter13h, CSR_SHPMCOUNTER13H)
DEFINE_CSR(shpmcounter14h, CSR_SHPMCOUNTER14H)
DEFINE_CSR(shpmcounter15h, CSR_SHPMCOUNTER15H)
DEFINE_CSR(shpmcounter16h, CSR_SHPMCOUNTER16H)
DEFINE_CSR(shpmcounter17h, CSR_SHPMCOUNTER17H)
DEFINE_CSR(shpmcounter18h, CSR_SHPMCOUNTER18H)
DEFINE_CSR(shpmcounter19h, CSR_SHPMCOUNTER19H)
DEFINE_CSR(shpmcounter20h, CSR_SHPMCOUNTER20H)
DEFINE_CSR(shpmcounter21h, CSR_SHPMCOUNTER21H)
DEFINE_CSR(shpmcounter22h, CSR_SHPMCOUNTER22H)
DEFINE_CSR(shpmcounter23h, CSR_SHPMCOUNTER23H)
DEFINE_CSR(shpmcounter24h, CSR_SHPMCOUNTER24H)
DEFINE_CSR(shpmcounter25h, CSR_SHPMCOUNTER25H)
DEFINE_CSR(shpmcounter26h, CSR_SHPMCOUNTER26H)
DEFINE_CSR(shpmcounter27h, CSR_SHPMCOUNTER27H)
DEFINE_CSR(shpmcounter28h, CSR_SHPMCOUNTER28H)
DEFINE_CSR(shpmcounter29h, CSR_SHPMCOUNTER29H)
DEFINE_CSR(shpmcounter30h, CSR_SHPMCOUNTER30H)
DEFINE_CSR(shpmcounter31h, CSR_SHPMCOUNTER31H)
...
DEFINE_CSR(vsstatus, CSR_VSSTATUS)
...
DEFINE_CSR(shpmcr, CSR_SHPMCR)
DEFINE_CSR(shpmsr, CSR_SHPMSR)
DEFINE_CSR(shpmer, CSR_SHPMER)
DEFINE_CSR(sl2pid, CSR_SL2PID)
DEFINE_CSR(siesr, CSR_SIESR)
DEFINE_CSR(sl2wp, CSR_SL2WP)
DEFINE_CSR(sl2wph, CSR_SL2WPH)
DEFINE_CSR(sbeaddr, CSR_SBEADDR)
DEFINE_CSR(ssbepa, CSR_SSBEPA)
DEFINE_CSR(ssbepa2, CSR_SSBEPA2)
DEFINE_CSR(scerh, CSR_SCERH)
DEFINE_CSR(scer2h, CSR_SCER2H)
...
DEFINE_CSR(scountovf, CSR_SCOUNTOVF)
DEFINE_CSR(cpuid, CSR_CPUID)
DEFINE_CSR(mcpuid, CSR_MCPUID)
DEFINE_CSR(mapbaddr, CSR_MAPBADDR)
DEFINE_CSR(mwmsr, CSR_MWMSR)
DEFINE_CSR(mapbaddr2, CSR_MAPBADDR2)
...
DEFINE_CSR(mdbginfo2h, CSR_MDBGINFO2H)
// DECLARE_CSR(mpipeinfo, CSR_MPIPEINFO)

// CSR Registers for Matrix
DEFINE_CSR(xmrstart, CSR_XMRSTART)
DEFINE_CSR(xmcsr, CSR_XMCSR)
DEFINE_CSR(xmsize, CSR_XMSIZE)
DEFINE_CSR(xmlenb, CSR_XMLENB)
DEFINE_CSR(xrlenb, CSR_XRLENB)
DEFINE_CSR(xmisa, CSR_XMISA)
